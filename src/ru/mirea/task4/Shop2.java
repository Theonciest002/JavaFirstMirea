...
import ru.mirea.task2.n4.Pc;

public class Shop2
{
    public void tutorial()
    {
        System.out.println("available actions:1-print all catalogues, 2-print wares of a catalogue, 3-add to list , 4-check list ,5 buy 0- tutorial");
    }
